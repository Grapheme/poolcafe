...
<?php endif;?>
	<ul class="menu-nav-list">
		...
		<li class="menu-nav-list-item item3">
			<a <?=($this->uri->segment(1) == 'bar')?'class="current-link"':'';?> href="<?=site_url('bar');?>"> <div></div> <span><?=$nav_menu[2]['title']?></span> </a>
		</li>
		<li class="menu-nav-list-item item4">
			<a <?=($this->uri->segment(1) == 'aquarium')?'class="current-link"':'';?> href="<?=site_url('aquarium');?>"> <div></div> <span><?=$nav_menu[3]['title']?></span> </a>
		</li>
	</ul>
</div>
<div class="clear"></div>