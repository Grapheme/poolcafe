	...
	<div class="container">
		<div class="row">
			...
			<div class="span9">
				...
				<div class="clear"></div>
				<?php $this->load->view('html/select-group-menu');?>
			<?php if($this->input->get('group') !== FALSE):?>
				<a href="<?=site_url(ADMIN_START_PAGE.'/categories/menu/add'.getUrlLink())?>" class="btn">Добавить категорию</a>
			<?php endif;?>
