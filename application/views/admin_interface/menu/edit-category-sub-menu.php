		...
		<div class="row">
			...
			<div class="span9">
				<ul class="breadcrumb">
					...
					<li><a href="<?=site_url(ADMIN_START_PAGE.'/categories/sub-menu');?>">Подкатегории меню</a><span class="divider">/</span></li>
					<li class="active">Редактирование подкатегории</li>
				</ul>
				<div class="clear"></div>
				<div class="result-request"></div>
				<?php $this->load->view('admin_interface/forms/categories/edit-sub-category-menu');?>
				<div class="clear"></div>
			</div>
		</div>
	</div>
