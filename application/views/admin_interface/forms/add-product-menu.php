...
<?=form_open(ADMIN_START_PAGE.'/menu/insert',array('class'=>'form-manage-events')); ?>
	<div class="control-group">
		<input type="text" name="title" class="span3 valid-required" value="" placeholder="Название" />
		<input type="text" name="property" class="span3" value="valid-required" placeholder="Вес, объем, размер" />
		<input type="text" name="price" class="span2" value="valid-required" placeholder="Цена" />
	</div>
	<div class="controls">
